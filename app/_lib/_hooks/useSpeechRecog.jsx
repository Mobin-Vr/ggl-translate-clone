...
const useSpeechRecognition = () => {
   ...
   const startRecording = () => {
      setIsRecording(true);
      CustomToast({ message: 'Recording started...' }); // Changed message for start
      ...
      recognitionRef.current.onerror = (event) => {
         ...
         CustomToast({ message: 'Please enable microphone access.' }); // Changed error message
      };
   ...
   const stopRecording = () => {
      if (recognitionRef.current) {
         ...
         CustomToast({ message: 'Recording stopped.' }); // Changed message for stop
      }
   };
